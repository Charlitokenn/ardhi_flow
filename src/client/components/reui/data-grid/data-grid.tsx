...
> {
    ...
    /** Extra className applied to each body `<tr>`, computed per row from its
     * data — e.g. tinting a row by status. Merged alongside the table's other
     * row classes (selection, striping, pinning), so it only needs to return
     * the status-specific classes. */
