  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 mb-4">
        ...
        <Card className="flex-row items-center gap-3 px-4">
          <div className="flex size-10 items-center justify-center rounded-full bg-violet-100 text-violet-600">
      ...
      >
        <TableActionBar table={table} onExport={() => exportSelected("transactions")} onDelete={handleBulkDelete} />
        ...
        formContent={
          viewingRow && (
            <div className="space-y-2 text-sm">
              ...
              <div><span className="text-muted-foreground">Transaction ID: </span>{transactionIdLabel(viewingRow)}</div>
              <div><span className="text-muted-foreground">Amount: </span>{formatCurrency(viewingRow.amount)}</div>
