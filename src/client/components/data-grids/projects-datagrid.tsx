                ...
                children={
                    viewingRow && (
                        <div className="space-y-2 text-sm">
                            ...
                            <div><span className="text-muted-foreground">Details: </span>{viewingRow.projectDetails ?? "—"}
                            </div>
                            <div><span className="text-muted-foreground">Owner: </span>{viewingRow.projectOwner ?? "—"}
                            </div>
                            ...
                            <div><span className="text-muted-foreground">Number of Plots: </span>{viewingRow.numberOfPlots}
                            </div>
                            <div><span className="text-muted-foreground">Sqm Bought: </span>{viewingRow.sqmBought ?? "—"}
                            </div>
                            <div><span
                                className="text-muted-foreground">Acquisition Value: </span>{formatCurrency(viewingRow.acquisitionValue)}
                            </div>
                            <div><span
                                className="text-muted-foreground">Acquisition Date: </span>{formatDate(viewingRow.acquisitionDate)}
                            </div>
                            <div><span className="text-muted-foreground">TP Status: </span>{viewingRow.tpStatus ?? "—"}
                            </div>
                            <div><span
                                className="text-muted-foreground">Survey Status: </span>{viewingRow.surveyStatus ?? "—"}
                            </div>
                        </div>
                    )
                }
