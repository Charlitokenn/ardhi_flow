...
export default function BroadcastFlow({onBack}: BroadcastFlowProps) {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Footer */}
            <footer className="border-t border-border bg-card/50 px-0 py-4">
                <div className="flex items-center justify-between">
                    <button
                        onClick={handlePrev}
                ...
                <div className={`rounded-[1.25rem] ${isSms ? 'bg-slate-100' : 'bg-white'} p-4 space-y-2`}>
                    {isSms ? (
                        ...
                        <div className="space-y-3">
                            ...
                            <div
                                className="bg-blue-500 text-white rounded-lg p-3 ml-auto max-w-xs text-xs wrap-break-word">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                <div
                                    className="bg-green-100 text-slate-900 rounded-lg rounded-br-none p-3 max-w-xs text-xs wrap-break-word">
