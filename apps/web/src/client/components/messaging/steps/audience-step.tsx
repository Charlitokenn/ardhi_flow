...
export default function AudienceStep({campaign, setCampaign}: AudienceStepProps) {
    ...
    return (
        <div className="max-w-2xl space-y-6">
            <div>
                <h2 className="text-xl font-medium text-foreground mb-6">Select Your Audience</h2>
                ...
                <div className="rounded-lg bg-muted/50 p-6 space-y-4">
                    ...
                    <div className="space-y-2">
                        {['Customers', 'Leads', 'VIP', 'Team'].map((group) => (
                            <label key={group}
                                   className="flex items-center gap-3 p-3 rounded border border-border hover:bg-muted/50 cursor-pointer">
