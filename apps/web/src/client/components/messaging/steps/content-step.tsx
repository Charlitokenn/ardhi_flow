...
export default function ContentStep({ campaign, setCampaign }: ContentStepProps) {
  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        <h2 className="text-xl font-semibold text-foreground mb-6">Message Content</h2>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            {campaign.type === 'sms' ? (
              <>
                SMS messages are limited to {maxLength} characters. Longer messages will be split into multiple SMS.
              </>
            ) : (
              <>
