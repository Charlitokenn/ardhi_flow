...
export interface MobileMockupProps {
    headerTitle?: string | undefined | null;
...
export function MobileMockup({
    ...
    return (
        <div
            className={cn(
                "xs:max-w-[265px] relative mx-auto flex w-full max-w-61.25 items-center justify-center py-2 select-none sm:max-w-71.25",
                className,
            )}
        >
            <motion.div
            ...
            >
                ...
                <div className="absolute top-48 -left-1.25 h-10 w-[2.5px] rounded-l-xs bg-neutral-700"/>
                <div className="absolute top-32 -right-1.25 h-14 w-[2.5px] rounded-r-xs bg-neutral-700"/>
                ...
                >
                    <div
                        className={cn(
                            "z-30 flex shrink-0 items-center justify-between px-4 pt-2 pb-1 text-[11px] font-semibold transition-colors",
                            variant === "sms"
                                ? "bg-[#dceefa] text-[#152d49] dark:bg-[#1c2733] dark:text-slate-100"
                                : "bg-[#008069] text-white dark:bg-[#111b21]",
                        )}
                    >
            <span className="w-12 text-left font-bold tracking-tight">
              {currentTime}
            </span>
                        ...
                        <div
                            className={cn(
                                ...
                                variant === "sms"
                                    ? "text-[#172b42] dark:text-slate-100"
                                    : "text-white",
                            )}
                        >
                    ...
                    <div
                        className={cn(
                            "z-20 flex shrink-0 items-center justify-between px-3 py-1.5 transition-colors",
                            variant === "sms"
                                ? "bg-[#dceefa] text-[#152d49] dark:bg-[#1c2733] dark:text-slate-100"
                                : "bg-[#008069] text-white dark:bg-[#111b21]",
                        )}
                        ...
                        <div className="flex items-center gap-1.5">
                            <button
                                ...
                                className={cn(
                                    "transition-colors",
                                    variant === "sms"
                                        ? "text-[#315d86] hover:text-[#172b42] dark:text-slate-300 dark:hover:text-white"
                            ...
                            <div
                                className="relative flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-full bg-emerald-700 text-[11px] font-bold text-white dark:bg-emerald-900">
                                {avatarUrl ? (
                                    <img
                                        src={avatarUrl}
                ...
                <span
                    className={cn(
                        "xs:max-w-[120px] max-w-[100px] truncate text-[11.5px] leading-tight font-semibold",
                        variant === "sms"
                            ? "text-[#172b42] dark:text-slate-100"
                            : "text-white",
                    )}
                >
                  {headerTitle}
                                ...
                                <span
                                    className={cn(
                                        "mt-0.5 text-[9.5px] leading-none font-medium",
                                        variant === "sms"
                                            ? "text-[#527797] dark:text-slate-400"
                                            : "text-emerald-200 dark:text-emerald-400",
                                    )}
                                >
                  {headerSubtitle}
                </span>
                        ...
                        >
                            <button
                                ...
                                className={cn(
                                    "transition-colors",
                                    variant === "sms"
                                        ? "hover:text-[#172b42] dark:hover:text-white"
                                        : "hover:text-white",
                                )}
                            >
                                {variant === "whatsapp" && (
                    ...
                    <div
                        className="relative flex min-h-0 flex-1 flex-col justify-end overflow-hidden bg-[#efeae2] p-2.5 transition-colors dark:bg-[#0b141a]">
                        {children ? (
                            <div
                                className="relative z-10 h-full w-full [scrollbar-width:none] overflow-y-auto [&::-webkit-scrollbar]:hidden">
                                {children}
                            </div>
                        ) : (
                            <>
                                <div
                                    className="relative z-10 mx-auto mb-1.5 rounded-full bg-white/90 px-2.5 py-0.5 text-[9px] font-medium text-neutral-600 dark:bg-[#182229]/90 dark:text-neutral-400">
                                    Today
                                </div>

                                <div
                                    className="relative z-10 flex flex-1 [scrollbar-width:none] flex-col justify-end space-y-1.5 overflow-y-auto [&::-webkit-scrollbar]:hidden">
                                                ...
                                                >
                                                    {msg.isImage ? (
                                                        <div className="flex min-w-[150px] flex-col gap-1">
                                                            <div
                                                                className="relative max-h-[100px] overflow-hidden rounded-lg">
                                                                {}
                                                                <img
                                                                    src={msg.imageUrl}
                                                                    alt="Attached media"
                                                    ...
                                                    <div
                                                        className="mt-0.5 flex items-center justify-end gap-1 self-end">
                            <span
                                className={cn(
                                    "text-[8.5px]",
                                    msg.isCurrentUser
                    ...
                    <div
                        className="z-20 flex shrink-0 items-center gap-1.5 bg-[#f0f2f5] p-2 transition-colors dark:bg-[#111b21]">
                        <button
                            type="button"
                        ...
                        <div
                            className="flex flex-1 items-center justify-between rounded-full bg-white px-3 py-1.5 text-xs text-neutral-400 dark:bg-[#2a3942] dark:text-neutral-400">
