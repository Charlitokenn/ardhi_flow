...
export function Scrollspy({
    ...
    useEffect(() => {
        ...
        // scrollTo(item) is a new closure on every call, so the listener added
        // here and the one passed to removeEventListener below must be the
        // *same* reference or the cleanup silently no-ops and listeners pile up
        // across re-renders (e.g. every time `children` changes).
