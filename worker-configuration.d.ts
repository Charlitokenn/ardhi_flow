/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4581c69ea94140f9c341623c06174755)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	TENANT_CACHE: KVNamespace;
	ardhi_flow_tenant_files: R2Bucket;
	TENANT_PROVISION_QUEUE: Queue;
	ASSETS: Fetcher;
	...
	VITE_PUBLIC_POSTHOG_ASSETS_HOST: string;
	DEV: string;
	TENANT_PRESENCE: DurableObjectNamespace<import("./src/worker/index").TenantPresence>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "TenantPresence";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_TENANT_REGION" | "CATALOG_DATABASE_URL" | "NEON_API_KEY" | "TENANT_CONN_ENCRYPTION_KEY" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "CLERK_JWT_KEY" | "VITE_PUBLIC_POSTHOG_PROJECT_TOKEN" | "VITE_PUBLIC_POSTHOG_HOST" | "VITE_PUBLIC_POSTHOG_ASSETS_HOST" | "DEV">> {}
}
